...
<img src="/assets/6_3D graphics/SuperBoardMrSon.png" width=300> 
<img src="/assets/6_3D graphics/Naruto.png" width=300>

제가 들었던 세션 중에서는,
**Mark Schoennagel**의 `"Real-time Ray Tracing In Unity's High Definition Render Pipeline Using Nvidia RTX"`, **Keijiro Takahashi**의 `"Unity 기술로 예술적 영감을 불어넣는 방법"`, 그리고 **Julien Frayer와 Thomas Iché**가 발표한 `"Visual Effect Graph로 실시간 VFX를 제작하는 방법"` 정도가 좋았습니다. 어떤 것인지는 아래 youtube나 twitter 영상을 참고해 주세요.



<https://www.youtube.com/watch?v=IY8FJxS4Lbs>
<iframe width="1280" height="720" src="https://www.youtube.com/embed/IY8FJxS4Lbs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

2019 BMW 8 Series Coupe를 NVIDIA RTX를 이용하여 Ray Tracing으로 표현한 영상 

<https://www.youtube.com/watch?v=rqMcPZoEc3U>
<iframe width="1280" height="720" src="https://www.youtube.com/embed/rqMcPZoEc3U" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
