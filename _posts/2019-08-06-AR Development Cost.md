...
일단 Jasoren은 AR 앱 개발 과정을 크게 기획 및 디자인, 개발, 테스팅 3단계로 나누었을 때 1800시간 정도 걸린다고 산출했습니다. 국내 법정근로시간(기준+연장)에 따라, 1주일에 52시간씩 일한다고 가정했을 때 **약 9개월에 가까운 시간**입니다. 비용은 어떨까요. 최대 190,000달러, 현재 한화로 **약 2억 3천만 원 정도의 비용**이 발생하는 것으로 나타납니다.

원문을 읽어보시면 아시겠지만, "depending on"이라는 단어가 자주 등장합니다. 산출된 시간과 비용이 절대적인 것이 아니라 **어느 정도의 '퀄리티'를 원하느냐에 따라 달라질 수 있는 상대적인 수치임**을 강조하고 있는데요. 여기서는 그 퀄리티의 기준을 아마존 AR View로 잡았다는 것을 감안해서 보시면 좋을 듯 합니다. 만약 AR View 보다 낮은 수준의 앱을 원한다면 시간과 비용이 훨씬 줄어들테고, 그 이상이라면 더 높아질 수 있겠죠.
